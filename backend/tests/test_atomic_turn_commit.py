...
class TestAsyncCommitTurn:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("emotional_state", "coping_mode", 123, "invalid_emotional_state"),
            ("emotional_state", "coping_mode", [], "invalid_emotional_state"),
            ...
            ("emotional_state", "timestamp", True, "invalid_emotional_state"),
            ...
            ("relationship_state", "timestamp", True, "invalid_relationship_state"),
            ("relationship_state", "triggers", "not-a-list", "invalid_relationship_state"),
            ("relationship_state", "triggers", [""], "invalid_relationship_state"),
            ("relationship_state", "triggers", [123], "invalid_relationship_state"),
            ("relationship_state", "triggers", ["   "], "invalid_relationship_state"),
            ("relationship_state", "triggers", [" padded "], "invalid_relationship_state"),
