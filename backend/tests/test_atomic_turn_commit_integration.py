...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("emotional", lambda state: state.update({"coping_mode": 123})),
        ("emotional", lambda state: state.update({"timestamp": 0.0})),
        ("emotional", lambda state: state.update({"timestamp": True})),
        ("relationship", lambda state: state.update({"timestamp": 0.0})),
        ("relationship", lambda state: state.update({"timestamp": True})),
        ("relationship", lambda state: state.update({"triggers": "not-a-list"})),
        ("relationship", lambda state: state.update({"triggers": [123]})),
        ("relationship", lambda state: state.update({"triggers": ["   "]})),
        ("relationship", lambda state: state.update({"triggers": [" padded "]})),
    ...
    ids=[
        ...
        "invalid-emotional-coping-mode-type",
        "invalid-emotional-timestamp",
        "invalid-emotional-timestamp-boolean",
        "invalid-relationship-timestamp",
        "invalid-relationship-timestamp-boolean",
        "relationship-triggers-not-list",
        "relationship-trigger-non-string",
        "relationship-trigger-whitespace",
        "relationship-trigger-untrimmed",
